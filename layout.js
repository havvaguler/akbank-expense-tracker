...
const transferUserNameField = document.querySelector(".transfer-TC");
...
const closeDialogUserName = document.querySelector(".closeTC");
...
let accounts = []; //account ve timer değişecek
let timer;
...
const displayTransactions = (currentUser, sort = false) => {
    ...
    movs.forEach((transaction, index) => {
        ...
        <p class="tag ${transactionType}-tag">${transactionType}</p>
...
/* DISPLAY BALANCE -----> her şeyin başlangıcı burası.!*/
...
//zamanlamada hata var, düzelticem.
// ay-gün-yıl şeklinde sıralanış hatası var, düzelticem